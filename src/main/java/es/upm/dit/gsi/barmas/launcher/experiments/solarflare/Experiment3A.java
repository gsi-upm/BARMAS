...
/**
 * Project: barmas
 * File: es.upm.dit.gsi.barmas.launcher.experiments.solarflare.Experiment3A.java
 * 
 ...
 * 
 */
public class Experiment3A implements Runnable {
	 ...
	 * @param seed
	 */
	public Experiment3A(String summaryFile, long seed, int mode,
			boolean validation) {
