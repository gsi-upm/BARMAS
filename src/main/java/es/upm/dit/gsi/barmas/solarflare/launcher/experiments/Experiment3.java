...
public class Experiment3 implements Runnable {
	...
	private static void launchSimulationWith2Agents(long seed,
		...
		AdvancedCentralManagerAgent manager = new AdvancedCentralManagerAgent(
				"Manager", experimentOutputPath, logger, (Integer) scenarioProperties.get(SimulationConfiguration.MODE));
	...
	public void run() {
		...
		Experiment3.launchSimulationWith2Agents(seed, summaryFile, mode);
		Experiment3.launchSimulationWith2AgentsKFold(seed, summaryFile, mode);
	}
