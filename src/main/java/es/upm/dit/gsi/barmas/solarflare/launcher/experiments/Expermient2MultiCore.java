 ...
 ******************************************************************************/
/**
 * es.upm.dit.gsi.barmas.solarflare.launcher.experiments.Expermient2MultiCore.java
 */
...
/**
 * Project: barmas File:
 * es.upm.dit.gsi.barmas.solarflare.launcher.experiments.Expermient2MultiCore
 * .java
 * 
 ...
 * 
 */
public class Expermient2MultiCore {
	...
	public static void main(String[] args) {
		...
		while (threshold > 0.01) {
			while (beliefThreshold > 0.01) {
				Experiment2Runnable r = new Experiment2Runnable(summaryFile,
...
class Experiment2Runnable implements Runnable {
	...
	public Experiment2Runnable(String summaryFile, long seed, double threshold,
